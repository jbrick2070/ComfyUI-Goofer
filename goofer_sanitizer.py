...
_BANANA_REPLACEMENTS = [
    # multi-word weapons & military
    ("machine guns",       "bunches of bananas"),
    ("machine gun",        "bunch of bananas"),
    ("shot guns",          "bunches of bananas"),
    ("shot gun",           "bunch of bananas"),
    ("shotgun",            "bunch of bananas"),
    ("shotguns",           "bunches of bananas"),
    ...
    ("bow and arrow",      "banana and peel"),
    ("nuclear weapon",     "giant banana"),
    ("nuclear bomb",       "giant banana"),
    # single weapons
    ("grenades",           "banana bombs"),
    ("grenade",            "banana bomb"),
    ("pistols",            "bananas"),
    ("pistol",             "banana"),
    ("revolvers",          "bananas"),
    ...
    ("guns",               "bananas"),
    ("gun",                "banana"),
    ("bullets",            "banana slices"),
    ("bullet",             "banana slice"),
    ("ammo",               "banana slices"),
    ("ammunition",         "banana slices"),
    ("missiles",           "flying bananas"),
    ("missile",            "flying banana"),
    ("torpedo",            "swimming banana"),
    ("bazooka",            "banana cannon"),
    ("blaster",            "banana blaster"),
    ("lasers",             "banana beams"),
    ("laser",              "banana beam"),
    ("tanks",              "armored banana carts"),
    ("tank",               "armored banana cart"),
    # violence verbs
    ("shooting",           "squirting with a banana"),
    ("shoot",              "squirt with a banana"),
    ("shoots",             "squirts with a banana"),
    ("shot",               "hit with a banana"),
    ("stabbing",           "poking with a banana"),
    ...
    ("assassinate",        "sneak a banana to"),
    ("slaughter",          "banana party"),
    ("massacre",           "banana party"),
    # gore
    ("bloody",             "juice-covered"),
    ("blood",              "banana juice"),
    ("bloodbath",          "banana smoothie"),
    ("gore",               "banana mess"),
    ("explosions",         "banana explosions"),
